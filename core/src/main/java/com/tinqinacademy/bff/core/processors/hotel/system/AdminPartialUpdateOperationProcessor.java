...
public class AdminPartialUpdateOperationProcessor extends BaseOperationProcessor implements AdminPartialUpdateBFFOperation {
    ...
    @Autowired
    public AdminPartialUpdateOperationProcessor(ConversionService conversionService, ErrorMapper errorMapper, Validator validator, HotelClient hotelClient) {
    ...
    public Either<Errors, AdminPartialUpdateBFFOutput> process(AdminPartialUpdateBFFInput input) {
        return Try.of(() -> {
                    ...
                    AdminPartialUpdateInput adminPartialUpdateInput = conversionService.convert(input, AdminPartialUpdateInput.class);

                    AdminPartialUpdateOutput adminPartialUpdateOutput = hotelClient.adminPartialUpdate(adminPartialUpdateInput, input.getRoomId().toString());

                    AdminPartialUpdateBFFOutput output = conversionService.convert(adminPartialUpdateOutput, AdminPartialUpdateBFFOutput.class);
